...
#define LCD_DCX_GPIO_PIN                    GPIO_PIN_1
...
#define LCD_CS_LOW()                        WRITE_REG(GPIOB->BSRR, (uint32_t)GPIO_PIN_10 << 16)
#define LCD_CS_HIGH()                       WRITE_REG(GPIOB->BSRR, GPIO_PIN_10)

/* Data/Command macro definition */
#define LCD_DC_LOW()                        WRITE_REG(GPIOB->BSRR, GPIO_PIN_1)
#define LCD_DC_HIGH()                       WRITE_REG(GPIOB->BSRR, (uint32_t)GPIO_PIN_1 << 16)
